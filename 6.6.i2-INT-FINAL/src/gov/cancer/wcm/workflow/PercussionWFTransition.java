...
public class PercussionWFTransition {
	...
	public static void transitionItem(int id, String trigger, String comment, 
		...
		{ 
			 ...
			 * 
			 * TODO: CRUFT ALERT! This needs to become a whitelist, without hard-coded references.
			 */
			if(oldParams.containsKey(RequireUIWarningIgnoreCondition.UI_WARNING_TRIGGER_FLAG)){
				req.setParameter(RequireUIWarningIgnoreCondition.UI_WARNING_TRIGGER_FLAG, oldParams.get(RequireUIWarningIgnoreCondition.UI_WARNING_TRIGGER_FLAG));
			}
