...
<html>
			...
			if(!matches) {
				...
				if (!valid)
					...
					if (document.getElementById('excel').checked == true) {
						df.action="tileAgingExcel.jsp";
					}
					else {
						df.action="tileAgingHtml.jsp";
					}
	...
	<body onload="javascript:self.focus();">
		<h1>Tile Aging Report</h1>
		<p>Indicates every time a particular tile was live on the site and whether it was published as a stand-alone tile or to the tile carousel.</p>
