...
<html>
	...
	<title>Content Items That Are Not Public Report</title>
	<script language="javascript">
		function doReport()
		{
			df=document.forms[0];
			if (document.getElementById('excel').checked == true) {
				df.action="notPublicExcel.jsp";
			}
			else {
				df.action="notPublicHtml.jsp";
			}
	...
	<body onload="javascript:self.focus();">
		<h1>Content Items That Are Not Public</h1>
		<p>Identifies content items that are not yet public.</p>
