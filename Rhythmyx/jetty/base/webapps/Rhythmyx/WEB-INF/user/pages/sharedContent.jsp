...
<html>
	...
	<title>Shared Content Report</title>
	<script language="javascript">
		function doReport()
		{
			df=document.forms[0];
			if (document.getElementById('excel').checked == true) {
				df.action="sharedContentExcel.jsp";
			}
			else {
				df.action="sharedContentHtml.jsp";
			}
	...
	<body onload="javascript:self.focus();">
		<h1>Shared Content Report</h1>
		<p>Identifies content items that are shared (excludes items shared due to inheritance, like the Site Banner, Site Footer, Section Navigation).</p>
