...
public class CGVConstants {
	 ...
	 public static String[] TOP_CONTENT_TYPE_NAMES = {"nciGeneral","nciLandingPage","cgvTopicSearchCategory","cgvClinicalTrialResult","cgvDrugInfoSummary","cgvFactSheet","cgvFeaturedClinicalTrial","cgvGeneric","cgvHome","cgvInclude","cgvPressRelease"};
