...
public class CGVConstants {
	 ...
	 public static String[] TOP_CONTENT_TYPE_NAMES = {"cgvSinglePageContent","nciLandingPage","cgvTopicSearchCategory","cgvClinicalTrialResult","cgvDrugInfoSummary","cgvFactSheet","cgvFeaturedClinicalTrial","cgvGeneric","cgvHome","cgvInclude","cgvPressRelease"};
