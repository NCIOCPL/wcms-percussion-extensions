 ...
 *
 */
public class CGov_TitlePopulate extends PSDefaultExtension implements
		IPSRequestPreProcessor {
	private static Logger LOGGER = CGov_Logger.getLogger(CGov_TitlePopulate.class);
	private static IPSContentWs cws = null;
	
	public CGov_TitlePopulate() {
		super();
		initServices();
	}
	...
	public void preProcessRequest(Object[] params, IPSRequestContext request)
		...
		String displaytitle = request.getParameter(CGovConstants.DISPLAY_TITLE_FLD);
